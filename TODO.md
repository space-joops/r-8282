...
1. **PR [#42](https://github.com/space-joops/r-8282/pull/42) 머지** (관전 가이드 방향 전환, #40 — UX 전환 2탄/최종)
   - PredictionPanel 'AI 경주 브리핑' 역전(총평 상단), 홈 '오늘의 관전 포인트', 소개 '베팅 가이드가 아니라 관전 가이드' 섹션, 메타 카피
   - 1탄(#39/PR #41 인터랙티브 대시보드)은 머지 완료 — 프로덕션 배포됨
...
## 진행 중 — 머지 대기
- **PR [#42](https://github.com/space-joops/r-8282/pull/42)**: 관전 가이드 방향 전환 (#40) — 위 시급 1번. 머지되면 UX 전환 작업 완료
